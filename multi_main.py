...
def parse_args():
    ...
    path_settings.add_argument('--model_dir', default='multi_task_outputs/models/',
                               help='the dir to store models')
    path_settings.add_argument('--result_dir', default='multi_task_outputs/results/',
                               help='the dir to output the results')
    path_settings.add_argument('--summary_dir', default='multi_task_outputs/summary/',
